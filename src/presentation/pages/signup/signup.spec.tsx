...
import { Helper, ValidationStub, AddAccountSpy, UpdateCurrentAccountnMock } from '@/presentation/test'
...
describe('Signup', () => {
  ...
  it('should call SaveAccessToken on success', async () => {
    const { sut, addAccountSpy, updateCurrentAccountnMock } = sutFactory()
