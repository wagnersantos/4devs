...
import { loginFactory, signupFactory, surveyListFactory, surveyResultFactory } from '@/main/factories/pages'
    ...
    >
      <BrowserRouter>
        <Switch>
          ...
          <PrivateRoute path="/surveys/:id" exact component={surveyResultFactory} />
        </Switch>
      </BrowserRouter>
    </ApiContext.Provider>
  )
